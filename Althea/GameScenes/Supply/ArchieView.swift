...
struct ArchieView: View {
    ...
    @EnvironmentObject var archie: ArchieScene
    ...
    var body: some View {
        ZStack {
            ...
            VStack {
                ...
                Button(action: {
                    archie.isMetalDetectorActive = true
                    print(archie.isMetalDetectorActive)
                    //MENYARI
                }) {
                ...
                if showCongratsView && archie.isPlayerInTreasureLocation && archie.isMetalDetectorActive {
                    CongratulationsView()
                }
                Button(action: {
                    showCongratsView = true
                    archie.isPlayerInTreasureLocation = true
                ...
                if showCongratsView && archie.isPlayerInTreasureLocation {
//                    CongratulationsView()
                }
                HStack {
